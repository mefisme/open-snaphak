...
const sig_entry BACKEND_ENGINE_SIGNATURES[] = {
    ...
    { "ToolReset",         /* FUN_140cdb3e0 -- the wire tool reset: sets the four pick slots
      ...
      0xCDB3E0u },
    /* --- wire-tool pick-RECLAIM primitive (called, not detoured) used by wiring_mode.c to convert an
     * in-progress wire pick into a clean wire-any cycle when the toggle flips ON mid-pick. It is
     ...
     * Re-derive (per DOOM build): decompile the named RVA. --- */
